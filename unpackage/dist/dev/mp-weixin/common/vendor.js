...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"我们的小窝","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 30 */
/*!******************************************!*\
  !*** E:/Mycode/couple-files2/pages.json ***!
  \******************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 46 */
/*!**********************************************!*\
  !*** E:/Mycode/couple-files2/store/index.js ***!
  \**********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.store = exports.TASK_TMPL_ID = exports.PLAN_TMPL_ID = void 0;
...
var TASK_TMPL_ID = 'URfKf5K9BKxfRyb3yHq5_Sukg7akmHimgXm8V3uEaOI'; // 待办任务开始提醒
exports.TASK_TMPL_ID = TASK_TMPL_ID;
var PLAN_TMPL_ID = 'xK2SHJHKJKChCYYb1HTIEwUduob7i9l__XlnHGILfSw'; // 旅行规划完成通知
exports.PLAN_TMPL_ID = PLAN_TMPL_ID;
var store = {
  coupleInfo: {
    name1: '小董',
    name2: '小王',
      ...
      return _regenerator.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return db().collection('tasks').orderBy('_createTime', 'desc').limit(100).get();
            case 2:
              res = _context.sent;
  ...
  toggleTask: function toggleTask(id, done) {
      ...
      return _regenerator.default.wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              _context5.next = 2;
              return db().collection('recipes').limit(100).get();
            case 2:
              res = _context5.sent;
      ...
      return _regenerator.default.wrap(function _callee7$(_context7) {
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              _context7.next = 2;
              return db().collection('recipes').doc(id).remove();
            case 2:
            case "end":
  ...
  voteRecipe: function voteRecipe(id) {
        ...
        while (1) {
          switch (_context8.prev = _context8.next) {
            case 0:
              database = db();
              _context8.next = 3;
              return database.collection('recipes').doc(id).update({
                data: {
                  votes: database.command.inc(1)
                }
              });
            case 3:
            case "end":
      ...
      return _regenerator.default.wrap(function _callee9$(_context9) {
        while (1) {
          switch (_context9.prev = _context9.next) {
            case 0:
              _context9.next = 2;
              return db().collection('plans').orderBy('_createTime', 'desc').limit(100).get();
            case 2:
              res = _context9.sent;
      ...
      return _regenerator.default.wrap(function _callee11$(_context11) {
        while (1) {
          switch (_context11.prev = _context11.next) {
            case 0:
              _context11.next = 2;
              return db().collection('plans').doc(id).remove();
            case 2:
            case "end":
  ...
  updatePlanStatus: function updatePlanStatus(id, status) {
      ...
      return _regenerator.default.wrap(function _callee12$(_context12) {
        while (1) {
          switch (_context12.prev = _context12.next) {
            case 0:
              _context12.next = 2;
              return db().collection('plans').doc(id).update({
                data: {
                  status: status
                }
              });
  ...
  subscribeAndNotify: function subscribeAndNotify(templateId, page, msgData) {
    return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee13() {
      var subRes, status, res, result, fail, msg;
      return _regenerator.default.wrap(function _callee13$(_context13) {
        while (1) {
          switch (_context13.prev = _context13.next) {
            ...
            case 3:
              subRes = _context13.sent;
              status = subRes[templateId];
              if (!(status !== 'accept')) {
                _context13.next = 8;
                break;
              }
              // reject=用户拒绝, ban=已永久拒绝, undefined=弹窗失败
              if (status === 'reject') uni.showToast({
                title: '已拒绝订阅，对方不会收到通知',
                icon: 'none',
                duration: 2000
              });
            ...
            case 10:
              ...
              if (result && result.notified > 0) {
                ...
                fail = result.results.find(function (r) {
                  return !r.success;
                });
                msg = fail ? '发送失败:' + fail.errCode + ' ' + (fail.errMsg || '') : '未知错误';
                uni.showToast({
                  title: msg,
                  icon: 'none',
                  duration: 4000
            ...
            case 16:
              ...
              uni.showToast({
                title: '通知失败:' + (_context13.t0.message || _context13.t0.errMsg || '未知错误'),
                icon: 'none',
                duration: 3000
              });
            case 19:
